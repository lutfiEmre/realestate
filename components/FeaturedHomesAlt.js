        ...
        <div className={'mt-[70px] flex flex-col justify-start items-center gap-[50px]'}>
            ...
            <div className={'flex flex-col lg:flex-row lg:gap-[50px] xl:gap-[100px] items-center'}>
                <div className={'lg:flex hidden flex-row  gap-0'}>
                    <div onClick={() => {cevirici('home')}}  className={'flex flex-col cursor-pointer gap-[17px] items-center '}>
                        <h1 className={`${activeF === 'home' ? 'text-dark600' : 'text-[#818181]'} murecho-medium text-[#818181] text-[19px]`}>Home</h1>
                        <div className={`${activeF === 'home' ? 'bg-dark600' : 'bg-[#E1E1E1]'} lg:w-[130px] xl:w-[150px] h-[4px] `}></div>
                    </div>
                    <div onClick={() => {cevirici('appointment')}} className={'flex flex-col cursor-pointer gap-[17px] items-center '}>
                        <h1 className={`${activeF === 'appointment' ? 'text-dark600' : 'text-[#818181]'} murecho-medium text-[#818181]  text-[19px]`}>Appointment</h1>
                        <div className={`${activeF === 'appointment' ? 'bg-dark600' : 'bg-[#E1E1E1]'}  lg:w-[130px] xl:w-[150px] h-[4px] `}></div>
                    </div>
                </div>
                <h1 className={' text-[40px] sm:text-[50px]  murecho-semibold text-[#0ADF9F]'}>Featured Homes</h1>
                <div className={'lg:flex hidden flex-row gap-0'}>
                    <div onClick={() => {cevirici('land')}}  className={'flex flex-col cursor-pointer gap-[17px] items-center '}>
                        <h1 className={`${activeF === 'land' ? 'text-dark600' : 'text-[#818181]'} murecho-medium text-[#818181]  text-[19px]`}>Land</h1>
                        <div className={`${activeF === 'land' ? 'bg-dark600' : 'bg-[#E1E1E1]'} lg:w-[130px] xl:w-[150px] h-[4px] `}></div>
                    </div>
                    <div onClick={() => {cevirici('all')}} className={'flex flex-col cursor-pointer gap-[17px] items-center '}>
                        <h1 className={`${activeF === 'all' ? 'text-dark600' : 'text-[#818181]'} murecho-medium text-[#818181]  text-[19px]`}>View All</h1>
                        <div className={`${activeF === 'all' ? 'bg-dark600' : 'bg-[#E1E1E1]'} lg:w-[130px] xl:w-[150px] h-[4px] `}></div>
                    </div>
                </div>
                <div className={'lg:hidden flex mt-[40px] items-center justify-center flex-wrap gap-[50px]'}>
                    <div className={' flex-col flex-wrap  flex gap-[25px] '}>
                        <div onClick={() => {cevirici('home')}}  className={'flex rounded-t-2xl relative w-[250px] h-[100px] bg-[#F6F6F6] justify-center flex-col cursor-pointer gap-[17px] items-center '}>
                            <h1 className={`${activeF === 'home' ? 'text-dark600' : 'text-[#818181]'} murecho-medium text-[#818181] text-[20px]`}>Home</h1>
                            <div className={`${activeF === 'home' ? 'bg-dark600' : 'bg-[#E1E1E1]'} absolute bottom-0 w-full lg:w-[100px] xl:w-[150px] h-[6px] lg:h-[3px] `}></div>
                        </div>
                        <div onClick={() => {cevirici('appointment')}} className={'flex rounded-t-2xl relative w-[250px] h-[100px] bg-[#F6F6F6] justify-center flex-col cursor-pointer gap-[17px] items-center '}>
                            <h1 className={`${activeF === 'appointment' ? 'text-dark600' : 'text-[#818181]'} murecho-medium text-[#818181] text-[20px]`}>Appointment</h1>
                            <div className={`${activeF === 'appointment' ? 'bg-dark600' : 'bg-[#E1E1E1]'} absolute bottom-0 w-full lg:w-[100px] xl:w-[150px] h-[6px] lg:h-[3px] `}></div>
                        </div>
                    </div>
                    <div className={'flex-col flex-wrap flex gap-[25px]'}>
                        <div onClick={() => {cevirici('land')}}  className={'flex rounded-t-2xl relative w-[250px] h-[100px] bg-[#F6F6F6] justify-center flex-col cursor-pointer gap-[17px] items-center '}>
                            <h1 className={`${activeF === 'land' ? 'text-dark600' : 'text-[#818181]'} murecho-medium text-[#818181] text-[20px]`}>Land</h1>
                            <div className={`${activeF === 'land' ? 'bg-dark600' : 'bg-[#E1E1E1]'} absolute bottom-0 w-full lg:w-[100px] xl:w-[150px] h-[6px] lg:h-[3px] `}></div>
                        </div>
                        <div onClick={() => {cevirici('all')}} className={'flex rounded-t-2xl relative w-[250px] h-[100px] bg-[#F6F6F6] justify-center flex-col cursor-pointer gap-[17px] items-center '}>
                            <h1 className={`${activeF === 'all' ? 'text-dark600' : 'text-[#818181]'} murecho-medium text-[#818181] text-[20px]`}>View All</h1>
                            <div className={`${activeF === 'all' ? 'bg-dark600' : 'bg-[#E1E1E1]'} absolute bottom-0 w-full lg:w-[100px] xl:w-[150px] h-[6px] lg:h-[3px] `}></div>
                        </div>
                    </div>
                </div>
            </div>
            <div className={' w-full h-full flex justify-center items-center'}>
                <div     className={'xl:w-[1000px] flex justify-center items-center md:ml-16 lg:mr-10 md:w-[700px] w-[300px] sm:w-[600px] lg:w-[900px]'}>
                    ...
                    >
                        {filtered.map((item,index) => (
                            <SwiperSlide> <div key={index} className={'relative w-fit'}>
...
export default FeaturedHomesAlt;
